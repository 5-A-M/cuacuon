            ...
            <div className="fsjidoajsioujeiowaa" style={{padding: 10}}>
                ...
                <UploadImage file={file} fileDataUrl={fileDataUrl} setFile={setFile} setFileDataUrl={setFileDataUrl} />
                {
                    ...
                    <>
                        ...
                        <Input placeholder="Nhập mã màu" type="text" value={codeColor} setValue={setCodeColor} title="Mã màu:" />
                        <Input placeholder="Nhập ô thoáng" type="text" value={openAir} setValue={setOpenAir} title="Ô thoáng:" />
                        <Input placeholder="Nhập thép làm cánh" type="text" value={steelForWings} setValue={setSteelForWings} title="Thép làm cánh:" />
                        <Input placeholder="Nhập thép làm khung" type="text" value={steelForFrame} setValue={setSteelForFrame} title="Thép làm khung:" />
                        <Input placeholder="Nhập Chất liệu thép" type="text" value={steelMaterial} setValue={setSteelMaterial} title="Chất liệu thép:" />
                        <Input placeholder="Nhập Bề mặt" type="text" value={surface} setValue={setSurface} title="Bề mặt:" />
                        <Input placeholder="Nhập độ dày cánh" type="text" value={thickWings} setValue={setThickWings} title="Độ dày cánh:" />
                        <Input placeholder="Nhập kính trên cánh cửa" type="text" value={glassDoor} setValue={setGlassDoor} title="Kính trên cánh cửa:" />
                        <Input placeholder="Nhập chiều rộng" type="text" value={width} setValue={setWidth} title="Chiều rộng: " />
                        <Input placeholder="Nhập chiều cao" type="text" value={height} setValue={setHeight} title="Chiều cao: " />
                        <Input placeholder="Nhập khóa" type="text" value={lock} setValue={setLock} title="Khóa: " />
                        <Input placeholder="Nhập bản lề" type="text" value={hinge} setValue={setHinge} title="Bản lề: " />
                        <Input placeholder="Nhập giá" type="text" value={price} setValue={setPrice} title="Giá" />
                ...
                }
                {
                    ...
                    <>
                        ...
                        <Input placeholder="Nhập màu sắc" type="text" value={color} setValue={setColor} title="Màu sắc:" />
                        <Input placeholder="Nhập số chìa đi kèm" type="text" value={keyIncluded} setValue={setKeyIncluded} title="Số chìa đi kèm:" />
                        <Input placeholder="Nhập chất liệu" type="text" value={material} setValue={setMaterial} title="Chất liệu:" />
                        <Input placeholder="Nhập tay ốp" type="text" value={handCover} setValue={setHandCover} title="Tay ốp:" />
                        <Input placeholder="Nhập thân khóa" type="text" value={lockBody} setValue={setLockBody} title="Thân khóa:" />
                        <Input placeholder="Nhập ổ khóa" type="text" value={lock} setValue={setLock} title="Ổ khóa:" />
